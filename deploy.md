...
```bash
# Build de l'image
docker build -t agence-partenaire .

# Exécution du conteneur
docker run -p 80:80 agence-partenaire
```
...
export default defineConfig({
  base: '/agence-partenaire/', // Nom du repository
...
```env
VITE_API_BASE_URL=https://api.agence-partenaire.com
