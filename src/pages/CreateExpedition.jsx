                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                    ...
                    <div className="mb-8">
                        <PageHeader
                            ...
                            actions={
                                <div className="flex items-center gap-0 bg-white border border-slate-200 rounded-lg p-1 shadow-sm">
                                            ...
                                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 p-4 bg-slate-50 rounded-lg border border-slate-200">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-9 px-3 ${getInputBorderClass(
                                                ...
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input 
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-9 px-3 ${getInputBorderClass(formData.pays_depart, false)}`}
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <label className="block text-xs font-semibold text-slate-500">
                                                ...
                                                <div key={index} className="p-5">
                                                    ...
                                                    <div className="flex items-center justify-between mb-4">
                                                        <div className="flex items-center gap-2">
                                                            <span className="w-6 h-6 rounded-lg bg-slate-100 flex items-center justify-center text-xs font-bold text-slate-600 border border-slate-200">
                                                                {index + 1}
                                                            </span>
                                                        ...
                                                        {formData.colis.length > 1 && (
                                                            <button
                                                                ...
                                                                className="flex items-center gap-1 px-2 py-1 text-xs text-red-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all"
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-3 mb-4">
                                                        <div className={formData.type_expedition.includes('DHD') ? "md:col-span-2" : "md:col-span-3"}>
                                                            ...
                                                            <input
                                                                ...
                                                                className={`w-full rounded-lg text-sm font-semibold h-9 px-3 ${getInputBorderClass(c.designation, true)}`}
                                                            />
                                                        </div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input
                                                                ...
                                                                placeholder="0"
                                                                className={`w-full rounded-lg text-sm font-semibold h-9 px-3 ${getInputBorderClass(c.poids, true)}`}
                                                            />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <SearchableDropdown
                                                                ...
                                                                className="mb-2"
                                                            />
                                                            <div className="flex flex-wrap gap-1.5 min-h-[34px] p-2 bg-slate-50 rounded-lg border border-slate-200">
                                                                {(c.articles || []).length > 0 ? (
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="grid grid-cols-4 gap-2">
                                                                <div>
                                                                    ...
                                                                    <input type="number" placeholder="0" value={c.longueur} onChange={(e) => handleColisChange(index, 'longueur', e.target.value)} className="w-full border-2 border-slate-300 rounded-lg text-xs p-2 bg-white text-center h-9 px-3 focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20" />
                                                                </div>
                                                                <div>
                                                                    <label className="block text-xs font-semibold text-slate-400 text-center mb-1">Larg. cm</label>
                                                                    <input type="number" placeholder="0" value={c.largeur} onChange={(e) => handleColisChange(index, 'largeur', e.target.value)} className="w-full border-2 border-slate-300 rounded-lg text-xs p-2 bg-white text-center h-9 px-3 focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20" />
                                                                </div>
                                                                <div>
                                                                    <label className="block text-xs font-semibold text-slate-400 text-center mb-1">Haut. cm</label>
                                                                    <input type="number" placeholder="0" value={c.hauteur} onChange={(e) => handleColisChange(index, 'hauteur', e.target.value)} className="w-full border-2 border-slate-300 rounded-lg text-xs p-2 bg-white text-center h-9 px-3 focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20" />
                                                                </div>
                                                                <div>
                                                                    <label className="block text-xs font-semibold text-slate-400 text-center mb-1">Emb. {getCurrencyLabel()}</label>
                                                                    <input type="number" value={c.prix_emballage} onChange={(e) => handleColisChange(index, 'prix_emballage', e.target.value)} className="w-full border-2 border-slate-300 rounded-lg text-xs p-2 bg-white text-center font-semibold text-slate-700 h-9 px-3 focus:border-slate-500 focus:ring-2 focus:ring-slate-500/20" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div className="p-6 space-y-4 flex-1">
                                            <div className="space-y-1.5">
                                                ...
                                                <input 
                                                    ...
                                                    autoFocus={step === 2}
                                                    className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.expediteur_nom_prenom, true)}`}
                                                />
                                            </div>
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input 
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.expediteur_telephone, true)}`}
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input 
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.expediteur_email, false)}`}
                                                    />
                                                </div>
                                            </div>
                                            <div className="space-y-1.5">
                                                ...
                                                <input 
                                                    ...
                                                    className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.expediteur_adresse, false)}`}
                                                />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="p-6 space-y-4 flex-1">
                                            <div className="space-y-1.5">
                                                ...
                                                <input 
                                                    ...
                                                    className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.destinataire_nom_prenom, true)}`}
                                                />
                                            </div>
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                <div className="space-y-1.5">
                                                    ...
                                                    <input 
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.destinataire_telephone, true)}`}
                                                    />
                                                </div>
                                                <div className="space-y-1.5">
                                                    <label className="block text-xs font-semibold text-slate-500">Email</label>
                                                    <input 
                                                        ...
                                                        className={`w-full rounded-lg text-sm font-semibold h-10 px-3 ${getInputBorderClass(formData.destinataire_email, false)}`}
                                                    />
                                                </div>
                                            </div>
                                            <div className="space-y-1.5">
                                                ...
                                                <textarea 
                                                    ...
                                                    className={`w-full rounded-lg text-sm font-semibold p-3 h-24 ${getInputBorderClass(formData.destinataire_adresse, false)}`}
                                                />
                                            </div>
                                        </div>
                                    </div>
