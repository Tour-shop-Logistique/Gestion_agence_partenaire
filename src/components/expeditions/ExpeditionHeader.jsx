...
const ExpeditionHeader = ({
    ...
    return (
        <div className="relative bg-white border-b border-slate-200/80">
            ...
            <div className="relative max-w-[1600px] mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8 space-y-3">
                <PageHeader
                    title="Expéditions"
                    subtitle={`Gérez et suivez vos ${totalCount} expédition${totalCount !== 1 ? 's' : ''} en temps réel`}
                    badge={
