 ...
 * stockage backend (`dial_code`/`indicatif_telephone` + `telephone`).
 *
 * Implémentation autonome (ne passe pas par SearchableDropdown) - copie
 * fidèle du PhoneInput du backoffice (même style, même comportement :
 * ouvert vers le bas, recherche en haut du menu avec autofocus), pour une
 * expérience identique entre les deux apps sur ce champ précis.
 *
 ...
 * par-dessus le reste de la page.
 *
