...
const DemandesAlert = ({ count, onView, onDismiss }) => {
    ...
    return (
        <div className="bg-gradient-to-r from-amber-50 to-amber-50/60 border border-amber-200 rounded-lg p-3 sm:p-4 flex items-center gap-2.5 sm:gap-3 shadow-sm animate-fade-in-down">
            ...
            <button
                onClick={onView}
                className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 bg-amber-600 text-white text-[10px] sm:text-xs font-semibold rounded-lg hover:bg-amber-700 active:scale-95 transition-all shadow-sm"
            >
                Voir
            </button>
            <button
