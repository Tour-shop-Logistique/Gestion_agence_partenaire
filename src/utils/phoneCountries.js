 ...
 * viennent de countries.json, pour rester cohérent avec le reste du projet.
 *
...
// voir Agence.telephone/whatsapp - un seul champ backend, pas de champ
// indicatif dédié) en { dialCode, localNumber } pour alimenter deux champs
// d'affichage séparés (voir PhoneInput). Si l'indicatif n'est pas
// reconnaissable (champ vide, ou ancien numéro sans "+"), dialCode reste ''
// et localNumber récupère les chiffres tels quels - l'utilisateur resaisit
// alors l'indicatif manquant.
