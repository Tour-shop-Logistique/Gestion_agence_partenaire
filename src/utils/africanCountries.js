 ...
 * src/data/african-countries.json, copié à l'identique dans backoffice-app
 * et tourshop-backend). Utilisé pour appliquer la règle géographique :
 * GROUPAGE_AFRIQUE -> Afrique uniquement, GROUPAGE_CA / GROUPAGE_DHD_* ->
 * tous pays HORS Afrique.
 */
